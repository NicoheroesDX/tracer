...
func _process(delta: float) -> void:
	if !trail_boost_area.is_active and Input.is_action_just_pressed("debug_3"):
		print("DEBUG: Added booster");
		#trail_boost_area.generate_booster(trail_first, trail_second);
	elif trail_boost_area.is_active and Input.is_action_just_pressed("debug_3"):
	...
	elif Input.is_action_just_pressed("debug_0"):
	...
	elif Input.is_action_just_pressed("debug_1"):
		print("DEBUG: Shortened trail 1");
